...
def main():
    ...
    queue = [(len(keyDct), 0, position, set(keyDct), set(doorDct))]
    seenDct = {}
    minDist = 10 ** 9
    while queue:
        l, dist, pos, keySet, doorSet = heapq.heappop(queue)
        ...
        while q:
            ...
            if p in keySet:
                ...
                heapq.heappush(
                    queue, (l - 1, dist + d, p, keySet - {p}, newDoorSet))
                continue
